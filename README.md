...
| -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Android TV</br>Sony BRAVIA</br>Fire TV</br>Roku</br>Apple TV</br>Samsung TV</br>Philips TV</br>Jellyfin</br>Generic Remote | remote.send_command                | command: action.key</br>Adds `hold_secs: 0.5` if hold action performed but a hold action is not defined.</br>Adds `device` if defined. |
